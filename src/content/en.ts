...
const en: SiteContent = {
  ...
  images: {
    services: "Planned photo: meeting table with a printed report and a laptop, hands pointing at a chart; natural light, neutral tones.",
    method: "Planned illustration: matrix of four families and fourteen fronts in navy, gold and olive green, editorial diagram style.",
    investors: "Planned photo: façade of a modern hospital or clinic in São Paulo at dusk, low angle.",
    contact: "Planned photo: consultant in conversation with two business owners, bright room, listening posture.",
    blog: "Planned image: editorial cover for the article, photograph of the sector with a navy overlay.",
    people: "Planned photo: clinic team in a short corridor huddle, uniforms, attentive expressions.",
  },
  consultant: {
  ...
  people: {
    ...
    intro: "One part of the consultancy looks at how the organisation is designed and at the people who hold it up. Partner psychologists on our team run the assessments; the consultancy integrates the results into the plan.",
    items: [
      { title: "Systemic organisational assessment", text: "How the company really works: roles, decisions, communication, dependencies and points of tension between areas. All of it read as a system, not as an org chart.", bullets: ["Map of roles and decisions", "Interviews and observation with management and teams", "Points of tension and overload by area"] },
      { title: "People assessment", text: "Psychological assessment of teams and leaders with validated instruments (resilience, occupational-stress and climate scales), applied by partner psychologists on our team and returned as management decisions.", bullets: ["Resilience and occupational-stress scales", "Profile of leaders and key teams", "Individual feedback and management report"] },
    ...
    note: "Psychological assessments are conducted by partner psychologists on our team, registered with the CRP, under the Federal Council of Psychology's resolutions.",
  },
  home: {
    heroTitle: "What holds growth back is not a lack of effort. It is a lack of multidisciplinary knowledge.",
    heroSub:
      "That is what the UN research behind the Empretec programme has shown for decades: those who grow combine knowledge across several fields with entrepreneurial behaviour. We bring the knowledge (market, marketing, regulation and people) and organise the behaviour into a plan with sequence, owner, cost and deadline. For hospitals, medical, dental, veterinary and aesthetic clinics in Brazil.",
    ...
    lenses: [
      ...
      { title: "People and organisation", text: "How the organisation really works and who holds it up: roles, decisions, leaders, team resilience and psychosocial risks. All assessed with method and integrated into the plan." },
    ],
    moves: [
  ...
  services: {
    ...
    items: [
      ...
      { slug: "people-and-organisation", name: "Organisational and people assessment", question: "Does the human structure hold the plan up?", deliverable: "Systemic organisational assessment and psychological assessment of teams and leaders (resilience, stress and climate scales), with a management report.", timeline: "3–5 weeks", detail: "Run by partner psychologists on our team with validated instruments; results enter the unlock plan as the people workstream." },

...
export default async function Home({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return (
    <>
      ...
      {/* FAQ */}
      <Section tone="cream"><Faq items={[...c.faq.slice(0, 3), ...c.faqAnalysis.slice(0, 3)]} title={t("faq")} /><div className="mt-6"><ButtonLink href="/faq" variant="secondary">FAQ →</ButtonLink></div></Section>

...
export default function FloatingActions() {
  ...
  return (
    <div className="pointer-events-none fixed bottom-20 right-4 z-40 flex flex-col items-end gap-3 lg:bottom-6 lg:right-6">
      <Link href="/ia" className="pointer-events-auto flex h-12 w-12 items-center justify-center rounded-full border border-gold/60 bg-navy text-gold shadow-lg hover:bg-navy-500 lg:h-14 lg:w-14" aria-label={t("ai")} title={t("ai")}>
        <Icons.sparkles className="h-6 w-6 lg:h-7 lg:w-7" />
      </Link>
